...
// in the Dashboard. Receives processes already filtered to the event's cycle + year.
...
export default function ProcessExpandPanel({ processes, onNavigate }) {
  ...
  return (
    <div className="bg-gray-50 border-t border-gray-100 px-10 py-4">
      ...
      <table className="w-full text-xs border-collapse mb-4">
        ...
        <tbody>
          {processes.map((p, i) => {
            const sty = STATUS_STYLES[p.status] || STATUS_STYLES['Planned'];
            return (
